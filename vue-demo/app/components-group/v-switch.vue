...
export default {
    ...
    created() {
        ...
        this.checked = this.dataKey.key === this.dataKey.values[0];
    },
    data() {
        return {
            checked: false
    ...
    methods: {
        setCheckbox() {
            ...
            this.dataKey.key = this.checked ? this.dataKey.values[0] : this.dataKey.values[1];
        }
    },
    watch: {
        'dataKey.key': {
